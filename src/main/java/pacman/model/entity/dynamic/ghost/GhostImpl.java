...
import pacman.model.entity.dynamic.ghost.strategies.ChaseBehaviour;
...
public class GhostImpl implements Ghost {
    ...
    public GhostImpl(Image image, BoundingBox boundingBox, KinematicState kinematicState, GhostMode ghostMode, Vector2D targetCorner, ChaseBehaviour chaseBehaviour, char GhostType) {
        this.image = image;
    ...
    private Vector2D getLastKnownBlinkyPosition() {
